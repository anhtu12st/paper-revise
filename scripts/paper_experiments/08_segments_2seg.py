...
def print_experiment_info(config):
    ...
    print("\n" + "=" * 80)
    print("📊 PAPER EXPERIMENT 08: SEGMENT ANALYSIS - 2 SEGMENTS")
    print("=" * 80)
    print()
    print("🎯 OBJECTIVE:")
    ...
    print(f"   • Max segments: {config.max_n_segs} (vs 6 in main)")
    print(f"   • Progressive: {config.progressive_segments}")
    print()
    print("💾 OUTPUT:")
...
def main():
    ...
    print("🚀 Starting Segment Analysis 08 (2 Segments)...\n")
