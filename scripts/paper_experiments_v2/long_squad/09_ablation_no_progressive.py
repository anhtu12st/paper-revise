#!/usr/bin/env python3
"""
Long SQuAD v2 - Ablation (No Progressive)
=========================================

Dataset: huutuan/long_squad_v2 (long documents, 6-12 segments)
Progressive segments: [6]
Memory: 8 tokens, no progressive

Purpose: Show benefit of progressive training

Output: outputs/paper_v2_long_09_ablation_no_progressive/
"""
...
def create_config():
    ...
    return TrainingConfig(
        ...
        run_name="paper-v2-long-ablation_no_progressive",
        save_total_limit=3,
...
def main():
    print("\n" + "=" * 80)
    print("📊 EXPERIMENT 09: LONG SQUAD V2 - ABLATION (NO PROGRESSIVE)")
    print("=" * 80 + "\n")
