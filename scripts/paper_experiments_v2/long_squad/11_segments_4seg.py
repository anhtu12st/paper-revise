#!/usr/bin/env python3
"""
Long SQuAD v2 - Medium Documents (4 segments)
=============================================

Dataset: huutuan/long_squad_v2 (long documents, 6-12 segments)
Progressive segments: [2, 4]
Memory: 8 tokens

Purpose: Performance on medium-length documents

Output: outputs/paper_v2_long_11_segments_4seg/
"""
...
def create_config():
    ...
    return TrainingConfig(
        ...
        run_name="paper-v2-long-segments_4seg",
        save_total_limit=3,
...
def main():
    print("\n" + "=" * 80)
    print("📊 EXPERIMENT 11: LONG SQUAD V2 - MEDIUM DOCUMENTS (4 SEGMENTS)")
    print("=" * 80 + "\n")
