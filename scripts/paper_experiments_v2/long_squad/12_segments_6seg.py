#!/usr/bin/env python3
"""
Long SQuAD v2 - Long Documents (6 segments)
===========================================
...
Output: outputs/paper_v2_long_12_segments_6seg/
"""
...
def create_config():
    ...
    return TrainingConfig(
        ...
        run_name="paper-v2-long-segments_6seg",
        save_total_limit=3,
...
def main():
    print("\n" + "=" * 80)
    print("📊 EXPERIMENT 12: LONG SQUAD V2 - LONG DOCUMENTS (6 SEGMENTS)")
    print("=" * 80 + "\n")
