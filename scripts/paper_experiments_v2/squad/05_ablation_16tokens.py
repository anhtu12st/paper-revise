#!/usr/bin/env python3
"""
Standard SQuAD v2 - Ablation (16 Tokens)
========================================
...
Output: outputs/paper_v2_squad_05_ablation_16tokens/
"""
...
def create_config():
    ...
    return TrainingConfig(
        ...
        run_name="paper-v2-squad-ablation_16tokens",
        save_total_limit=3,
...
def main():
    print("\n" + "=" * 80)
    print("📊 EXPERIMENT 05: SQUAD V2 - ABLATION (16 TOKENS)")
    print("=" * 80 + "\n")
