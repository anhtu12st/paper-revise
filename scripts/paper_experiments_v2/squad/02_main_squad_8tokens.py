#!/usr/bin/env python3
"""
Standard SQuAD v2 - Main (8 Memory Tokens)
===========================================

Dataset: squad_v2 (standard)
Max segments: 2
Memory: 8 tokens (main configuration)

Purpose: Main result on standard benchmark.

Output: outputs/paper_v2_squad_02_main_8tokens/
"""
...
def create_config():
    ...
    return TrainingConfig(
        ...
        run_name="paper-v2-squad-main-8tokens",
        save_total_limit=3,
...
def main():
    print("\n" + "=" * 80)
    print("📊 EXPERIMENT 02: SQUAD V2 - MAIN (8 TOKENS)")
    print("=" * 80 + "\n")
