#!/usr/bin/env python3
"""
Standard SQuAD v2 - Ablation (32 Tokens)
========================================
...
Output: outputs/paper_v2_squad_06_ablation_32tokens/
"""
...
def create_config():
    ...
    return TrainingConfig(
        ...
        run_name="paper-v2-squad-ablation_32tokens",
        save_total_limit=3,
...
def main():
    print("\n" + "=" * 80)
    print("📊 EXPERIMENT 06: SQUAD V2 - ABLATION (32 TOKENS)")
    print("=" * 80 + "\n")
